...
public class MainActivity2 extends AppCompatActivity {
    ...
    public class MyStringCallback extends StringCallback
    {
        ...
        public void onResponse(String response, int id)
        {
            ...
            {
                case 100:
                    Toast.makeText(MainActivity2.this, "http", Toast.LENGTH_SHORT).show();
                    break;
                case 101:
                    Toast.makeText(MainActivity2.this, "https", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    ...
    public void postFile(View view)
    {
        ...
        if (!file.exists())
        {
            Toast.makeText(MainActivity2.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        }
